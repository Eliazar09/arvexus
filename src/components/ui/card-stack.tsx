    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ background: 'rgb(230 57 70 / 0.04)' }}
          aria-hidden="true"
        />
        <div
            ...
            {items.map((item, i) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={cn(
                    "absolute bottom-0 rounded-2xl border border-white/10 overflow-hidden",
            ...
            {items.map((it, idx) => {
              ...
              return (
                <button
                  ...
                  style={on ? { backgroundColor: 'rgb(var(--red))' } : undefined}
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-ink-2 text-sm text-paper-soft">
            No image
          </div>
        )}
      </div>
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        {item.tag && (
          <span className="font-mono text-[9px] uppercase tracking-[0.18em] text-white/50 mb-2">
            {item.tag}
          </span>
        )}
